            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">공지 관리</a></li>
                    ...
                    <article>
                        ...
                        <div class="ms-6 me-6 mb-6">
                            <div class="mb-2">
                                ...
                                <textarea class="form-control notice-box textarea-fixed" id="notice" placeholder="공지 내용을 입력하세요."></textarea>
                            </div>
                            <button type="button" class="btn btn-primary" style="float:right">저장</button>
                        </div>
                        <div class="ms-6 me-6 mb-6">
                            <div class="mb-2">
                                <label for="rule" class="form-label"><h4><strong>규칙</strong></h4></label>
                                <textarea class="form-control notice-box textarea-fixed" id="rule" placeholder="규칙 내용을 입력하세요."></textarea>
                            </div>
                            <button type="button" class="btn btn-primary" style="float:right">저장</button>
                        </div>
                    </article>
